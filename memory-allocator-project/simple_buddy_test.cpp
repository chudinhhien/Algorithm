...
int main() {
    ...
    if (ptr1) {
        std::cout << "✓ Allocated 256 bytes - Current max level: " << allocator.get_current_max_level() << std::endl;
    ...
    if (ptr2) {
        std::cout << "✓ Allocated 128 bytes - Current max level: " << allocator.get_current_max_level() << std::endl;
    ...
    if (ptr3) {
        std::cout << "✓ Allocated 64 bytes - Current max level: " << allocator.get_current_max_level() << std::endl;
    ...
    if (ptr4) {
        std::cout << "✓ Allocated 32 bytes - Current max level: " << allocator.get_current_max_level() << std::endl;
    ...
    std::cout << "Before: Tree height was fixed during initialization\n";
    std::cout << "After: Tree height grows dynamically based on actual allocations\n";
